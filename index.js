...
/////////////////
const BotName = 'VICKY BOT☄'; 
const instagram = 'https://instagram.com/vickex.cill'; 
const telegram = 'Tidak punya'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCmdKTpvXAGSjT9sgz9861bw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@vickex.cill')
